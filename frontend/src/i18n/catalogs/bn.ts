...
export const BENGALI_CATALOG = {
  ...
  "interfaceLanguage.label": "ইন্টারফেসের ভাষা",
  "interfaceLanguage.description":
    "নেভিগেশন, ফর্ম এবং পৃষ্ঠার লেবেল পরিবর্তন করে। এটি অ্যাকশন প্ল্যানের ভাষা পরিবর্তন করে না।",
  ...
  "languageContext.changeAction": "অ্যাকশন প্ল্যানের ভাষা পরিবর্তন করুন",
  ...
  "form.privacyTitle": "জমা দেওয়ার আগে",
  ...
  "form.identityWarning":
    "নাম, যোগাযোগের তথ্য, ঠিকানা বা পরিচয় শনাক্ত করতে পারে এমন অন্য কোনো তথ্য দেবেন না।",
  "form.situationLabel": "তাপজনিত পরিস্থিতি বর্ণনা করুন",
  "form.characterCount": "{{currentCount}} / {{limit}} কোড পয়েন্ট",
  "form.characterCountOverLimit":
    "{{currentCount}} / {{limit}} কোড পয়েন্ট — সীমার চেয়ে {{overLimitCount}} বেশি",
  "form.situationHint":
    "সর্বোচ্চ {{limit}} ইউনিকোড কোড পয়েন্ট ব্যবহার করুন। বয়স, ঠান্ডা থাকার সুবিধা, চলাফেরা, সময় অথবা সীমিত পরিসরের সতর্কতামূলক উপসর্গ বর্ণনা করতে পারেন।",
  ...
  "trust.privacyDescription":
    "পরিস্থিতির লেখা ব্রাউজার স্টোরেজে সংরক্ষিত হয় না। স্পষ্টভাবে বেছে নেওয়া ভিজ্যুয়াল মোড, ইন্টারফেস ভাষা এবং অ্যাকশন প্ল্যানের ভাষার পছন্দ স্থানীয়ভাবে সংরক্ষিত হয়। শুধু নির্বাচিত অ্যাকশন প্ল্যানের ভাষা কোড অনুরোধে যায়; ভিজ্যুয়াল মোড ও ইন্টারফেস ভাষা যায় না। এই ডেমোতে HeatRelay অ্যানালিটিক্স, কুকি, URL প্যারামিটার বা ভূ-অবস্থান ব্যবহার করে না।",
