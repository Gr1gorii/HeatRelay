...
"visualMode.label": "दृश्य मोड",
  ...
  "interfaceLanguage.label": "इंटरफ़ेस की भाषा",
  "interfaceLanguage.description":
    "नेविगेशन, फ़ॉर्म और पेज के लेबल बदलती है। यह कार्य-योजना की भाषा नहीं बदलती।",
  ...
  "languageContext.changeAction": "कार्य-योजना की भाषा बदलें",
  ...
  "form.privacyTitle": "जमा करने से पहले",
  ...
  "form.identityWarning":
    "नाम, संपर्क विवरण, पते या पहचान बताने वाली अन्य जानकारी शामिल न करें।",
  "form.situationLabel": "गर्मी की स्थिति का वर्णन करें",
  "form.characterCount": "{{currentCount}} / {{limit}} कोड पॉइंट",
  "form.characterCountOverLimit":
    "{{currentCount}} / {{limit}} कोड पॉइंट — सीमा से {{overLimitCount}} अधिक",
  "form.situationHint":
    "अधिकतम {{limit}} Unicode कोड पॉइंट का उपयोग करें। आप उम्र, ठंडक की उपलब्धता, चलने-फिरने की क्षमता, समय या सीमित चेतावनी लक्षणों का वर्णन कर सकते हैं।",
  ...
  "trust.privacyDescription":
    "स्थिति का पाठ ब्राउज़र स्टोरेज में संग्रहीत नहीं होता। स्पष्ट रूप से चुनी गई दृश्य-मोड, इंटरफ़ेस-भाषा और कार्य-योजना-भाषा प्राथमिकताएँ स्थानीय रूप से सहेजी जाती हैं। केवल चुनी गई कार्य-योजना भाषा का कोड कार्य-योजना अनुरोध में जाता है; दृश्य मोड और इंटरफ़ेस भाषा नहीं जाते। HeatRelay इस डेमो में एनालिटिक्स, कुकी, URL पैरामीटर या जियोलोकेशन का उपयोग नहीं करता।",
