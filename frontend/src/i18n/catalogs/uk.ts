...
"visualMode.label": "Візуальний режим",
  ...
  "interfaceLanguage.label": "Мова",
  "interfaceLanguage.description":
    "Змінює мову інтерфейсу та наступного плану дій. Не перекладає ваш опис і не переписує показаний план.",
  ...
  "languageContext.changeAction": "Змінити мову",
  ...
  "form.privacyTitle": "Конфіденційність і умови демоверсії",
  ...
  "trust.privacyDescription":
    "Текст ситуації не зберігається у сховищі браузера. Явно вибрані параметри візуального режиму та мови зберігаються локально. До запиту плану дій входить лише код вибраної мови; візуальний режим не входить. У цій демонстрації HeatRelay не використовує аналітику, файли cookie, параметри URL або геолокацію.",
