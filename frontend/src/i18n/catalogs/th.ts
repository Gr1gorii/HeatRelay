...
"visualMode.label": "โหมดการแสดงผล",
  ...
  "interfaceLanguage.label": "ภาษาของอินเทอร์เฟซ",
  "interfaceLanguage.description":
    "เปลี่ยนการนำทาง แบบฟอร์ม และป้ายกำกับในหน้า แต่ไม่เปลี่ยนภาษาของแผนปฏิบัติการ",
  ...
  "languageContext.changeAction": "เปลี่ยนภาษาของแผนปฏิบัติการ",
  ...
  "form.identityWarning":
    "อย่าใส่ชื่อ ข้อมูลติดต่อ ที่อยู่ หรือข้อมูลอื่นที่สามารถระบุตัวตนได้",
  "form.situationLabel": "อธิบายสถานการณ์เกี่ยวกับความร้อน",
  "form.characterCount": "{{currentCount}} / {{limit}} จุดรหัส",
  "form.characterCountOverLimit":
    "{{currentCount}} / {{limit}} จุดรหัส — เกินขีดจำกัด {{overLimitCount}} จุด",
  "form.situationHint":
    "ใช้ได้สูงสุด {{limit}} จุดรหัสยูนิโคด คุณสามารถอธิบายอายุ การเข้าถึงวิธีคลายร้อน การเคลื่อนไหว ช่วงเวลา หรืออาการเตือนที่อยู่ภายในขอบเขตที่กำหนด",
  ...
  "trust.privacyDescription":
    "ข้อความเกี่ยวกับสถานการณ์จะไม่ถูกเก็บในพื้นที่จัดเก็บของเบราว์เซอร์ ค่ากำหนดโหมดการแสดงผล ภาษาของอินเทอร์เฟซ และภาษาของแผนปฏิบัติการที่เลือกไว้อย่างชัดเจนจะถูกจัดเก็บไว้ในเครื่อง มีเพียงรหัสภาษาของแผนปฏิบัติการที่เลือกเท่านั้นที่รวมอยู่ในคำขอ ส่วนโหมดการแสดงผลและภาษาของอินเทอร์เฟซจะไม่รวมอยู่ HeatRelay ไม่ใช้การวิเคราะห์ คุกกี้ พารามิเตอร์ URL หรือตำแหน่งทางภูมิศาสตร์ในเดโมนี้",
